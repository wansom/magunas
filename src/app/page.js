...
export default function Home() {
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    <span className="inline-block p-3 text-[#6FBF42] rounded-full bg-[#ECFFDC] dark:bg-gray-800">
                    ...
                    <p className="mt-2 text-sm text-[#6FBF42] dark:text-[#6FBF42]">hello@merakiui.com</p>
                </div>
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 20.25c4.97 0 9-3.694 9-8.25s-4.03-8.25-9-8.25S3 7.444 3 12c0 2.104.859 4.023 2.273 5.48.432.447.74 1.04.586 1.641a4.483 4.483 0 0 1-.923 1.785A5.969 5.969 0 0 0 6 21c1.282 0 2.47-.402 3.445-1.087.81.22 1.668.337 2.555.337Z" />
                    ...
                    <p className="mt-2 text-sm text-[#6FBF42] dark:text-[#6FBF42]">Start new chat</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-[#6FBF42] dark:text-blue-400">100 Smith Street Collingwood VIC 3066 AU</p>
                </div>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-[#6FBF42] dark:text-[#6FBF42]">+1 (555) 000-0000</p>
                </div>
            </div>
          </div>
